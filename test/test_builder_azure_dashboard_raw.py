...
def test_produce_the_template_with_host_and_base_path_options():
    ...
    expected_endpoints_ordered, total_operations, operations = _build_expected_endpoints_and_ops_count_for_oas2(spec_dict)
...
#     expected_endpoints_ordered, total_operation_instances, operations = _build_expected_endpoints_and_ops_count_for_oas3(spec_dict)
#
