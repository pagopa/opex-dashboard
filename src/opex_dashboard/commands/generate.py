...
def generate(template_name: str,
    ...
    properties = {
        ...
        "evaluation_frequency": config.get("evaluation_frequency", 10),
        "evaluation_time_window": config.get("evaluation_time_window", 20),
        "availability_threshold": config.get("availability_threshold", 0.99),
        "response_time_threshold": config.get("response_time_threshold", 1.0),
        "event_occurrences": config.get("event_occurrences", 1),
